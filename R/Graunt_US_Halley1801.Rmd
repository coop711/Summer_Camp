...
```{r, geom aes, fig.width = 4, fig.height = 4, eval = FALSE}
...
```{r, geom_point geom_line, fig.width = 6, fig.height = 6, eval = FALSE}
(gu1 <- ggplot() + 
...
```{r, polygon, fig.width = 6, fig.height = 6, eval = FALSE}
(gup3 <- gu3 + 
...
```{r, axis labels, fig.width = 6, fig.height = 6, eval = FALSE}
(gu4 <- gu3 + 
   xlab(x_lab) + 
   ylab(y_lab))
```
...
```{r, ggtitle, fig.width = 6, fig.height = 6, eval = FALSE}
(gu4 <- gu3 + 
   xlab(x_lab) + 
   ylab(y_lab) + 
...
```{r, legends title, fig.width = 6, fig.height = 6, eval = FALSE}
(gu4 <- gu3 + 
   xlab(x_lab) + 
   ylab(y_lab) + 
   ggtitle(main_title_g_us) +
...
```{r, change legends, fig.width = 6, fig.height = 6, eval = FALSE}
(gu4 <- gu3 + 
   xlab(x_lab) + 
   ylab(y_lab) +
   ggtitle(main_title_g_us) +
...
```{r, legends inside, fig.width = 6, fig.height = 6, eval = FALSE}
(gu5 <- gu4 + 
...
```{r, axis tick marks, fig.width = 6, fig.height = 6, eval = FALSE}
(gu6 <- gu5 + 
   scale_x_continuous(breaks = graunt$x) + 
   scale_y_continuous(breaks = graunt$xPo_g))
...
```{r, start with p4, fig.width = 6, fig.height = 6, eval = FALSE}
gup4
```
...
```{r, title and axis labels,  fig.width = 6, fig.height = 6, eval = FALSE}
(gup5 <- gup4 + 
   xlab(x_lab) + 
   ylab(y_lab) +
   ggtitle(main_title_g_us))
...
```{r, text polygon,  fig.width = 6, fig.height = 6, eval = FALSE}
(gup6 <- gup5 + 
   annotate("text", 
...
```{r, familiar axis labels, fig.width = 6, fig.height = 6, eval = FALSE}
(gup7 <- gup6 + 
   scale_x_continuous(breaks = graunt$x) + 
   scale_y_continuous(breaks = graunt$xPo_g))
