...
ggplot(data = poll_tbl, 
  ...
  geom_text(aes(y = pos, label = paste0(poll, "%")), size = 5, vjust = 1) +
  geom_text(aes(y = pos, label = key), 
            size = 5, vjust = -1, colour = "white", family = "KoPubWorldDotum Medium") +
  xlim(1.2, 2.5) +
  labs(title = "고위공직자 범죄수사처 설립 찬반", x = NULL, y = NULL) +
