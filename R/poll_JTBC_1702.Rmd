...
text(x = b1, 
     y = rates,
#      y = rates + c(rep(-3, 4), rep(1.5, 2)), 
     labels = rates, 
     pos = c(rep(1, 4), rep(3, 2)),
     col = c("black", "white")[c(1, 1, 1, 2, 1, 1)],
#     c("black", "black", "black", "white", "black", "black"),
     cex = 1.5)
...
box(which = "figure", 
    lwd = 3)
dev.copy(png, "../pics/jtbc1702.png", 
         width = 640, 
         height = 320)
dev.off()
```
...
#                           y = rates + c(rep(-3, 4), rep(2, 2)),
                          y = rates,
                          vjust = c(rep(1.5, 4), rep(-0.5, 2)),
                          label = rates), 
            colour = c("black", "white")[c(1, 1, 1, 2, 1, 1)],
            size = 6))
(g5 <- g4 +
